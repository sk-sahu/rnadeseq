...
```{r download_files, bootstrap.show.message=FALSE, echo=FALSE, message=FALSE}
download.file(url = "https://raw.githubusercontent.com/sk-sahu/rnadeseq/optional-file-handling/assets/corp-styles.css", destfile = "corp-styles.css")
download.file(url = "https://raw.githubusercontent.com/sk-sahu/rnadeseq/optional-file-handling/assets/references.bibtex", destfile = "references.bibtex")
download.file(url = "https://raw.githubusercontent.com/sk-sahu/rnadeseq/optional-file-handling/assets/logo.png", destfile = "logo.png")
```
